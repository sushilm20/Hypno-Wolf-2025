...
import com.arcrobotics.ftclib.spline.CubicHermiteSpline
import io.liftgate.robotics.mono.pipeline.RootExecutionGroup
import io.liftgate.robotics.mono.pipeline.single
import org.robotics.robotics.xdk.teamcode.autonomous.geometry.Pose
import org.robotics.robotics.xdk.teamcode.autonomous.position.guidedvectorfield.CubicBezierCurve
import org.robotics.robotics.xdk.teamcode.autonomous.position.guidedvectorfield.GuidedVectorFieldPositionChangeAction
import org.robotics.robotics.xdk.teamcode.autonomous.position.guidedvectorfield.Vector2D
import org.robotics.robotics.xdk.teamcode.autonomous.position.purepursuit.PurePursuitPositionChangeAction
...
fun Pose.toVector2D() = Vector2D(x, y)
...
{
    val command = GuidedVectorFieldPositionChangeAction(curve, this)
    command.configure()
